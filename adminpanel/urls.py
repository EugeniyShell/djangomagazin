...
urlpatterns = [
    ...
    path('categories/create/', adminpanel.category_create,
         name='category_create'),
    path('categories/read/<int:pk>/', adminpanel.category_view,
         name='category_view'),
    path('categories/update/<int:pk>/', adminpanel.category_update,
         name='category_update'),
    path('categories/delete/<int:pk>/', adminpanel.category_delete,
         name='category_delete'),

    path('products/create/', adminpanel.product_create, name='product_create'),
    path('products/read/<int:pk>/', adminpanel.product_view,
         name='product_view'),
    path('products/update/<int:pk>/', adminpanel.product_update,
         name='product_update'),
    path('products/delete/<int:pk>/', adminpanel.product_delete,
         name='product_delete'),
    ...
    path('basket/update/<int:pk>/', adminpanel.basket_update,
         name='basket_update'),
    path('basket/delete/<int:pk>/', adminpanel.basket_delete,
         name='basket_delete'),
]
